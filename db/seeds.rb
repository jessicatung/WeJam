...
def seed
  ...
  Musician.create(username: "Derek Reeve", password: "password", email: "derek@devbootcamp.com", location: "San Francisco, CA", instrument: "Drums", genre: "Emo Metal", skill_level: "Badass", url: "http://about.me/derekreeve", gravatar_url: Faker::Internet.url, notes: "Drummer, software developer, avid listener of music and taker of pictures. Former Chicagoan, now a resident of the Bay Area.", available: [false, true].sample, lat: 37.781270, long:-122.421450)
  ...
  Musician.create(username: "Sandra Cohen", password: "password", email: "sandra@mail.com", location: "San Francisco", instrument: "Voice", genre: "Jazz", skill_level: "Crooner Extroardinaire", url: "http://bobandraa.github.io/", gravatar_url: "https://secure.gravatar.com/avatar/1dc61e7e8e719de264e49630ea290117.png?r=PG&d=mm&s=150", notes: "I love jamming to jazz and funk, working on my guitar skills. Accapella is my jam, looking for opporunities!", available: [false, true].sample, lat: 37.789933, long:-122.394307)
